...
public class IOSReview extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public CharSequence rating;
   ...
   */
  public IOSReview(CharSequence date, CharSequence body, CharSequence rating, CharSequence version) {
    this.date = date;
    this.body = body;
    this.rating = rating;
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: date = (CharSequence)value$; break;
    case 1: body = (CharSequence)value$; break;
    case 2: rating = (CharSequence)value$; break;
   ...
   * @param value the value to set.
   */
  public void setRating(CharSequence value) {
    this.rating = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<IOSReview>
    ...
    /**
      ...
      * @return This builder.
      */
    public IOSReview.Builder setDate(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public IOSReview.Builder setBody(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public IOSReview.Builder setRating(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public IOSReview.Builder setVersion(CharSequence value) {
    ...
    public IOSReview build() {
      try {
        ...
        record.date = fieldSetFlags()[0] ? this.date : (CharSequence) defaultValue(fields()[0]);
        record.body = fieldSetFlags()[1] ? this.body : (CharSequence) defaultValue(fields()[1]);
        record.rating = fieldSetFlags()[2] ? this.rating : (CharSequence) defaultValue(fields()[2]);
