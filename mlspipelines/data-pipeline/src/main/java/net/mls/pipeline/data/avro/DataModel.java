 ...
 */
package net.mls.pipeline.data.avro;
...
public class DataModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static net.mls.pipeline.data.avro.DataModel.Builder newBuilder() {
    return new net.mls.pipeline.data.avro.DataModel.Builder();
  }
   ...
   * @return A new DataModel RecordBuilder
   */
  public static net.mls.pipeline.data.avro.DataModel.Builder newBuilder(net.mls.pipeline.data.avro.DataModel.Builder other) {
    return new net.mls.pipeline.data.avro.DataModel.Builder(other);
  }
   ...
   * @return A new DataModel RecordBuilder
   */
  public static net.mls.pipeline.data.avro.DataModel.Builder newBuilder(net.mls.pipeline.data.avro.DataModel other) {
    return new net.mls.pipeline.data.avro.DataModel.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DataModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.mls.pipeline.data.avro.DataModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.mls.pipeline.data.avro.DataModel other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.text)) {
        this.text = data().deepCopy(fields()[0].schema(), other.text);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.DataModel.Builder setText(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.DataModel.Builder clearText() {
      text = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.DataModel.Builder setAfterRelease(java.lang.Boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.DataModel.Builder clearAfterRelease() {
      afterRelease = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.DataModel.Builder setVersion(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.DataModel.Builder clearVersion() {
      version = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.DataModel.Builder setLabel(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.DataModel.Builder clearLabel() {
      label = null;
