...
public class IOSReview extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static net.mls.pipeline.data.avro.IOSReview.Builder newBuilder() {
    return new net.mls.pipeline.data.avro.IOSReview.Builder();
  }
   ...
   * @return A new IOSReview RecordBuilder
   */
  public static net.mls.pipeline.data.avro.IOSReview.Builder newBuilder(net.mls.pipeline.data.avro.IOSReview.Builder other) {
    return new net.mls.pipeline.data.avro.IOSReview.Builder(other);
  }
   ...
   * @return A new IOSReview RecordBuilder
   */
  public static net.mls.pipeline.data.avro.IOSReview.Builder newBuilder(net.mls.pipeline.data.avro.IOSReview other) {
    return new net.mls.pipeline.data.avro.IOSReview.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<IOSReview>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.mls.pipeline.data.avro.IOSReview.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.mls.pipeline.data.avro.IOSReview other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.date)) {
        this.date = data().deepCopy(fields()[0].schema(), other.date);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.IOSReview.Builder setDate(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.IOSReview.Builder clearDate() {
      date = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.IOSReview.Builder setBody(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.IOSReview.Builder clearBody() {
      body = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.IOSReview.Builder setRating(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.IOSReview.Builder clearRating() {
      rating = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.IOSReview.Builder setVersion(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.mls.pipeline.data.avro.IOSReview.Builder clearVersion() {
      version = null;
